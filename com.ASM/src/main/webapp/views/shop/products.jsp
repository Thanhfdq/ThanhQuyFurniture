				...
				<div class="catagories-menu">
					<ul>
						<c:forEach var="item" items="${categories}">
							<li class=""><a href="/shop/products?category=${item.id}">${item.name}</a></li>
						</c:forEach>
					</ul>
				</div>
			</div>
				...
				<div class="row">
						...
						<div class="col-12 col-sm-6 col-md-12 col-xl-6">
							<div class="single-product-wrapper">
								...
								<div class="product-img">
									...
									<!-- Hover Thumb -->
									<img class="hover-img"
										src="/assets/images/product-img/product2.jpg" alt="">
								</div>
					...
					<div class="col-12 col-sm-6 col-md-12 col-xl-6">
						<div class="single-product-wrapper">
							<!-- Product Image -->
							<div class="product-img">
								<img src="/assets/images/product-img/product2.jpg" alt="">
								<!-- Hover Thumb -->
								<img class="hover-img"
									src="/assets/images/product-img/product3.jpg" alt="">
							</div>
					...
					<div class="col-12 col-sm-6 col-md-12 col-xl-6">
						<div class="single-product-wrapper">
							...
							<div class="product-img">
								...
								<!-- Hover Thumb -->
								<img class="hover-img"
									src="/assets/images/product-img/product4.jpg" alt="">
							</div>
					...
					<div class="col-12 col-sm-6 col-md-12 col-xl-6">
						<div class="single-product-wrapper">
							<!-- Product Image -->
							<div class="product-img">
								<img src="/assets/images/product-img/product4.jpg" alt="">
								<!-- Hover Thumb -->
								<img class="hover-img"
									src="/assets/images/product-img/product5.jpg" alt="">
							</div>
					...
					<div class="col-12 col-sm-6 col-md-12 col-xl-6">
						<div class="single-product-wrapper">
							<!-- Product Image -->
							<div class="product-img">
								<img src="/assets/images/product-img/product5.jpg" alt="">
								<!-- Hover Thumb -->
								<img class="hover-img"
									src="/assets/images/product-img/product6.jpg" alt="">
							</div>
					...
					<div class="col-12 col-sm-6 col-md-12 col-xl-6">
						<div class="single-product-wrapper">
							<!-- Product Image -->
							<div class="product-img">
								<img src="/assets/images/product-img/product6.jpg" alt="">
								<!-- Hover Thumb -->
								<img class="hover-img"
									src="/assets/images/product-img/product1.jpg" alt="">
							</div>
