...
<div class="mobile-nav">
	...
	<div class="amado-navbar-brand">
		<a class="fw-bold fs-5 text-center" href="/shop/index"><i
			class="bi bi-unity"></i> Thanh<b class="text-warning">Quy</b>
			<p>Furniture</p></a>
	</div>
	<!-- Navbar Toggler -->
...
<header class="header-area clearfix">
	...
	<!-- Logo -->
	<div class="logo">
		<a class="fw-bold fs-3 text-center" href="/shop/index"><i
			class="bi bi-unity"></i> Thanh<b class="text-warning">Quy</b>
			<p>Furniture</p></a>
	</div>
	<!-- Amado Nav -->
	...
	<div class="cart-fav-search mb-100">
		<a href="cart.html" class="cart-nav"><img
			src="/assets/images/core-img/cart.png" alt=""> Cart <span>(0)</span></a>
		<a href="#" class="fav-nav"><img
			src="/assets/images/core-img/favorites.png" alt=""> Favourite</a> <a
			href="#" class="search-nav"><img
			src="/assets/images/core-img/search.png" alt=""> Search</a>
	</div>
	<!-- Social Button -->
